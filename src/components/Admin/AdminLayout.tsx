...
const AdminContainer = styled.div`
  min-height: 100vh;
  background: linear-gradient(135deg, #90ccec 0%, #CDA434 100%);
  display: flex;
  flex-direction: column;
`;

const TopBar = styled.div`
  background: linear-gradient(135deg, #CDA434 0%, #90ccec 100%);
  color: #000000;
  padding: 1rem 2rem;
  display: flex;
  justify-content: space-between;
  align-items: center;
  box-shadow: 0 8px 32px rgba(205, 164, 52, 0.3);
  position: sticky;
  top: 0;
  z-index: 100;
  backdrop-filter: blur(20px);
  border-bottom: 3px solid rgba(124, 252, 0, 0.3);
`;
...
const TopBarButton = styled.button`
  ...
  &:hover {
    background: linear-gradient(135deg, #7CFC00 0%, #CDA434 100%);
...
const NavButton = styled.button<{ $active?: boolean }>`
  background: ${props => props.$active ? 'linear-gradient(135deg, #7CFC00 0%, #CDA434 100%)' : 'rgba(255, 255, 255, 0.2)'};
  color: ${props => props.$active ? '#000000' : '#000000'};
  border: 2px solid ${props => props.$active ? 'rgba(124, 252, 0, 0.3)' : 'rgba(255, 255, 255, 0.3)'};
  ...
  &:hover {
    background: ${props => props.$active ? 'linear-gradient(135deg, #CDA434 0%, #7CFC00 100%)' : 'linear-gradient(135deg, #7CFC00 0%, #CDA434 100%)'};
    border-color: ${props => props.$active ? 'rgba(205, 164, 52, 0.5)' : 'rgba(124, 252, 0, 0.5)'};
    color: #000000;
    transform: translateY(-2px);
    box-shadow: 0 8px 25px rgba(124, 252, 0, 0.3);
  }
...
const Sidebar = styled.aside`
  width: 280px;
  background: rgba(255, 255, 255, 0.95);
  border-right: 2px solid rgba(205, 164, 52, 0.3);
  padding: 2rem 0;
  position: sticky;
  top: 144px;
...
const CategoryButton = styled.button<{ $active?: boolean }>`
  background: ${props => props.$active ? 'linear-gradient(135deg, #7CFC00 0%, #CDA434 100%)' : 'rgba(255, 255, 255, 0.9)'};
  color: ${props => props.$active ? '#000000' : '#000000'};
  border: 2px solid ${props => props.$active ? 'rgba(124, 252, 0, 0.3)' : 'rgba(255, 255, 255, 0.3)'};
...
const ModalContent = styled.div`
  ...
  box-shadow: 0 20px 50px rgba(205, 164, 52, 0.2);
`;
...
const ModalButton = styled.button<{ $danger?: boolean }>`
  padding: 0.75rem 1.5rem;
  border-radius: 8px;
  border: 2px solid ${props => props.$danger ? 'rgba(239, 68, 68, 0.3)' : 'rgba(124, 252, 0, 0.3)'};
  background: ${props => props.$danger ? 'rgba(239, 68, 68, 0.9)' : 'linear-gradient(135deg, #7CFC00 0%, #CDA434 100%)'};
  ...
  &:hover {
    background: ${props => props.$danger ? 'rgba(220, 38, 38, 0.95)' : 'linear-gradient(135deg, #CDA434 0%, #7CFC00 100%)'};
    border-color: ${props => props.$danger ? 'rgba(239, 68, 68, 0.5)' : 'rgba(205, 164, 52, 0.5)'};
    transform: translateY(-2px);
    box-shadow: 0 8px 25px rgba(124, 252, 0, 0.3);
  }
`;
